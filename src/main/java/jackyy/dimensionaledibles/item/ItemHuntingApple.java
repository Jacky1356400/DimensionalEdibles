...
public class ItemHuntingApple extends ItemFood {
	public ModConfig.DimensionConfig config = ModConfig.hunting;

	public ItemHuntingApple() {
		super(4, 0.3F, false);
		setAlwaysEdible();
		setRegistryName(DimensionalEdibles.MODID + ":hunting_apple");
		setTranslationKey(DimensionalEdibles.MODID + ".hunting_apple");
