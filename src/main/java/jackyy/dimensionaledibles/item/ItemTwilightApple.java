...
public class ItemTwilightApple extends ItemFood {
	public ModConfig.DimensionConfig config = ModConfig.twilight;

	public ItemTwilightApple() {
		super(4, 0.3F, false);
		setAlwaysEdible();
		setRegistryName(DimensionalEdibles.MODID + ":twilight_apple");
		setTranslationKey(DimensionalEdibles.MODID + ".twilight_apple");
