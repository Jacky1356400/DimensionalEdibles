...
public class ItemMiningApple extends ItemFood {
	public ModConfig.DimensionConfig config = ModConfig.mining;

	public ItemMiningApple() {
		super(4, 0.3F, false);
		setAlwaysEdible();
		setRegistryName(DimensionalEdibles.MODID + ":mining_apple");
		setTranslationKey(DimensionalEdibles.MODID + ".mining_apple");
