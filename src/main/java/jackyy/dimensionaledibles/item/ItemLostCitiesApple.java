...
public class ItemLostCitiesApple extends ItemFood {
	public ModConfig.DimensionConfig config = ModConfig.lostcities;

	public ItemLostCitiesApple() {
		super(4, 0.3F, false);
		setAlwaysEdible();
		setRegistryName(DimensionalEdibles.MODID + ":lostcities_apple");
		setTranslationKey(DimensionalEdibles.MODID + ".lostcities_apple");
