...
public class ItemErebusApple extends ItemFood {
	public ModConfig.DimensionConfig config = ModConfig.erebus;

	public ItemErebusApple() {
		super(4, 0.3F, false);
		setAlwaysEdible();
		setRegistryName(DimensionalEdibles.MODID + ":erebus_apple");
		setTranslationKey(DimensionalEdibles.MODID + ".erebus_apple");
