...
public class BlockVoidCake extends BlockCakeBase implements ITileEntityProvider {
	public ModConfig.DimensionConfig config = ModConfig.thevoid;

	public BlockVoidCake() {
		super();
		setRegistryName(DimensionalEdibles.MODID + ":void_cake");
		setTranslationKey(DimensionalEdibles.MODID + ".void_cake");
	}
