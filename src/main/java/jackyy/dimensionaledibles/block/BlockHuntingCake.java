...
public class BlockHuntingCake extends BlockCakeBase implements ITileEntityProvider {
	public ModConfig.DimensionConfig config = ModConfig.hunting;

	public BlockHuntingCake() {
		super();
		setRegistryName(DimensionalEdibles.MODID + ":hunting_cake");
		setTranslationKey(DimensionalEdibles.MODID + ".hunting_cake");
	}
