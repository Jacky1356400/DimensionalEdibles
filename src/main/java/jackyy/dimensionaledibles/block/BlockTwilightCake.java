...
public class BlockTwilightCake extends BlockCakeBase implements ITileEntityProvider {
	public ModConfig.DimensionConfig config = ModConfig.twilight;

	public BlockTwilightCake() {
		super();
		setRegistryName(DimensionalEdibles.MODID + ":twilight_cake");
		setTranslationKey(DimensionalEdibles.MODID + ".twilight_cake");
	}
