...
public class BlockMiningCake extends BlockCakeBase implements ITileEntityProvider {
	public ModConfig.DimensionConfig config = ModConfig.mining;

	public BlockMiningCake() {
		super();
		setRegistryName(DimensionalEdibles.MODID + ":mining_cake");
		setTranslationKey(DimensionalEdibles.MODID + ".mining_cake");
	}
